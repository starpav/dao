...
var CONTRACT_NAME = "dev-1637777034588-60590994973156" || 'dao.aiko.testnet';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/pavel", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              changeMethods: ['setGreeting', 'addCandidate']
            });
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, fieldset, candidate;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, candidate = _event$target$element.candidate; // disable the form while the value gets updated on-chain
